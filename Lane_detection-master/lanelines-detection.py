...
white_output = dir_video+'test_out.mp4'
clip1 = VideoFileClip(dir_video+'test.mp4')
...
def process_image(image):
    ...
    imshape = [720,1280]
    vertices = np.array([[(200,imshape[0]-80),(490,imshape[0]*0.65),                         (820,imshape[0]*0.65),(imshape[1]-150,imshape[0]-80),                         (100,imshape[0]-80)]],dtype=np.int32)
